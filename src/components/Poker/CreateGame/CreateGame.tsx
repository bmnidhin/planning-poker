        ...
        <div className='flex flex-col gap-4'>
          ...
          <fieldset>
            ...
            <div className='flex flex-col gap-2'>
              {[
                ...
                { type: GameType.ShortFibonacci, label: 'Short Fibonacci (0, ½, 1, 2, 3, 5, 8, 13, 20, 40, 100)' },
                { type: GameType.TShirt, label: 'T-Shirt (XXS, XS, S, M, L, XL, XXL)' },
                { type: GameType.TShirtAndNumber, label: 'T-Shirt & Numbers (S, M, L, XL, 1, 2, 3, 4, 5)' },
          ...
          {gameType === GameType.Custom && (
            <>
              ...
              {error && (
                <p className='text-red-600 text-xs mt-1'>Please enter values for at least two custom option.</p>
              )}
            </>
          )}
